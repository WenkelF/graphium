...
graphium-train \
    ...
    trainer.model_checkpoint.dirpath=model_checkpoints/large-dataset/scale_mpnn_1M/a/40/ \
    constants.entity=recursion \
    constants.name=scale_large_data_mpnn_1M_a \
    constants.wandb.entity=recursion \
    constants.wandb.project=graphium-scaling \
    trainer.trainer.check_val_every_n_epoch=1 \
    +architecture.mup_scale_factor=0.27 \
