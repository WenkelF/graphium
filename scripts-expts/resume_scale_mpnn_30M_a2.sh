...
graphium-train \
    ...
    trainer.model_checkpoint.dirpath=model_checkpoints/large-dataset/scale_mpnn_30M/a2/ \
    constants.entity=recursion \
    constants.name=scale_large_data_mpnn_30M_a2 \
    ...
    +trainer.resume_from_checkpoint=model_checkpoints/large-dataset/scale_mpnn_30M/a2/last.ckpt \