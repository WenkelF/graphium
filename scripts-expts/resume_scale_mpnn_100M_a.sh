...
graphium-train \
    ...
    trainer.model_checkpoint.dirpath=model_checkpoints/large-dataset/scale_mpnn_100M/a/ \
    ...
    +trainer.resume_from_checkpoint=model_checkpoints/large-dataset/scale_mpnn_100M/a/last.ckpt \