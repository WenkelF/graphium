...
GRAPHIUM_PRETRAINED_MODELS_DICT = {
    ...
    "large-mpnn": "pretrained_models/large/mpnn.ckpt",
    "10M-old1": "pretrained_models/large/mpnn-v2.ckpt",
    "10M-old2": "pretrained_models/large/mpnn_10M/last.ckpt",
    "large-mpnn-30M": "pretrained_models/large/mpnn_30M/a2/60eps.ckpt",
    "large-mpnn-100M": "pretrained_models/large/mpnn_100M/a/50eps.ckpt",
    "1M": "pretrained_models/scales/1M/best-60.ckpt",
    "3M": "pretrained_models/scales/3M/best-67.ckpt",
    "10M": "pretrained_models/scales/10M/best-63.ckpt",
    "30M": "pretrained_models/scales/30M/last-60.ckpt",
    "100M": "pretrained_models/scales/100M/last-60.ckpt",
    # "1M": "pretrained_models/scales/1M/last-43.ckpt",
    # "3M": "pretrained_models/scales/3M/last-29.ckpt",
    # "10M": "pretrained_models/scales/10M/last-17.ckpt",
    # "30M": "pretrained_models/scales/30M/last-50.ckpt",
    # "100M": "pretrained_models/scales/100M/last-60.ckpt",
}
